...
```{r exercise 5.5, exercise = TRUE}
# Check the structure of planets_df

#
```

```{r exercise 5.5-solution}
# Check the structure of planets_df
str(planets_df)
#
```
...
```{r example 5.10.2, exercise = TRUE}
...
```{r example 5.11.2, exercise = TRUE}
a[order(a)]
```
...
```{r example 5.11.3, exercise = TRUE}
